...
<table><%
     String num=request.getParameter("accountno");
		...
		if(status==true){
			...
			PreparedStatement ps=con.prepareStatement("Select * from SYSTEM2.NEWACCOUNT where accountno=?");
			...
			PreparedStatement ps1=con1.prepareStatement("update SYSTEM2.NEWACCOUNT set amount=? where accountno='"+accountno+"'");

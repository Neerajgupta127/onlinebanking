...
<table><%
		...
		if(status==true){
			...
			PreparedStatement ps=con.prepareStatement("Select * from SYSTEM2.NEWACCOUNT where accountno='"+taccountno+"'");
			...
			PreparedStatement ps1=con1.prepareStatement("update SYSTEM2.NEWACCOUNT set amount=? where accountno='"+taccountno+"'");
			...
			PreparedStatement ps2=con2.prepareStatement("Select * from SYSTEM2.NEWACCOUNT where accountno=?");
			...
			PreparedStatement ps3=con3.prepareStatement("update SYSTEM2.NEWACCOUNT set amount=? where accountno='"+accountno+"'");
